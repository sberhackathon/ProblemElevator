...
class Passenger:
    def __init__(self, add_action, id: int, elevator, x: float, y: float, state: int, time_to_away: int,
                 from_floor: int, dest_floor: int, type: str, floor: float, weight: float):
        self.add_action = add_action
        self.id = id
